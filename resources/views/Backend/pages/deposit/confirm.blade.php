...
@section('title') Deposit Successfully @endsection
  @section('body')
  ...
  <div class="order-success-wrapper">
      <div class="custom-container">
        <div class="order-done-content">
          ...
          <h5>Your deposit is confirmed!</h5>
          <p>Your deposit ID is <strong class="badge bg-light text-dark shadow-sm me-2 fz-14">#{{ $traxId->traxId }}. </strong>Keep this ID remember for further assistance. Thank you!</p><a class="btn btn-warning mt-3" href="{{ route('homepage') }}">Back to dashboard</a>
        </div>
      </div>
    </div>
    </div>

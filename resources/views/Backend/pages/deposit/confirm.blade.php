  ...
  <div class="order-success-wrapper">
      <div class="custom-container">
        <div class="order-done-content">
          ...
          <p>Your deposit ID is <strong class="badge bg-light text-dark shadow-sm me-2 fz-14">#20A11F15N. </strong>Keep this ID remember for further assistance. Thank you!</p><a class="btn btn-warning mt-3" href="{{ route('homepage') }}">Back to dashboard</a>
        </div>
      </div>
    </div>
    </div>

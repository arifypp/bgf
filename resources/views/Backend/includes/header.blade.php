    ...
    <!-- Title -->
    <title> @yield('title') | BGF - House Builder Family</title>
	<!-- Fonts -->
    ...
    <!-- PWA  -->
    <meta name="theme-color" content="#0d5afd"/>
    <link rel="apple-touch-icon" href="{{ asset('/assets/img/icons/icon-180x180.png') }}">
    <link rel="manifest" href="{{ asset('/assets/img/icons/icon-180x180.png') }}">
